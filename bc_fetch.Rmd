...
This program creates files dataset.csv and bc_fetch_results.RData.

dataset.csv lists the sites and database names.

bc_fetch_results.RData is a list (fetch) with more 
information to help you access the individual
databases.
...
Generate an API key and put it, along with your choice of data file directory, in the auxilary `bcread_api_key.R` file a la:

```{r eval=FALSE}
v.dbdatafiledir <- '~/bc-data-files'
