...
saveRDS(site$ptobs,  paste0(v.output.dir,dataset$bc_db,"-",Sys.Date(),"-pt-obs.rds"))
...
v.filename <- paste0(v.output.dir,dataset$site,"-",dataset$record_id,"-BCDatamart-Consented.csv")
write.csv(q.site.datamart, file = v.filename, row.names=FALSE)
message('Number of rows written: ',nrow(q.site.datamart))

v.filename <- paste0(v.output.dir,dataset$site,"-",dataset$record_id,"-BCDatamart-IssuesLog.csv")
