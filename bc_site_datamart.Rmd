...
v.site.study.ids <- read.csv(paste0("~/GPC-Development/bc-datamart/KUMC-study_id_to_order_num.csv"))
...
v.site.survey.set <- merge(v.site.survey.set, v.site.study.ids,
                           by.x="row_number",
                           by.y="ORDER_ID")
colnames(v.site.survey.set)[colnames(v.site.survey.set)=="STUDY_ID"] <- "gpc.study.id"
colnames(v.site.survey.set)[colnames(v.site.survey.set)=="row_number"] <- "gpc.sample.set.row.number"
