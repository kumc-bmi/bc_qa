...
stopifnot(
  length(duplicated(unique(
    survey.sample[, c('patient_num', 'female', 'adult', 'not.dead', 'english')])$patient_num)) == 0)

dem.states <- table(unique(survey.sample[, c('patient_num', 'female', 'adult', 'not.dead', 'english')])[, -1])
plot(dem.states,
