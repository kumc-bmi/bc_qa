...
*TODO: note issues/todos are at the bottom.*
*TODO: discuss previous article re query terms, exclusion criteria.*
...
*in progress: normalize `\I2B2\Cancer Cases\NN` to `\i2b2\naaccr\S:NN` at the start of paths.*
...
tumor.site <- dbGetQuery(conn.site,
                         ...
                         join concept_dimension cd
                         on cd.concept_cd = f.concept_cd
                         where concept_path like '%naaccr%'
...
**TODO: Show term details for missing stuff.**
