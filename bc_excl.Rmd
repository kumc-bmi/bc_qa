...
var.exclusion <- c('sex', 'seq.no', 'confirm', 'morphology', 'stage', 'vital')
```
...
tumor.site2 <- with.var.pat(tumor.site, conn.site, var.vital.tr$concept_path, 'deceased.ehr')
```
...
```{r}
summary(tumor.site[, var.exclusion])
